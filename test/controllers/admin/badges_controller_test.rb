...
class Admin::BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_badge" do
    assert_difference('Admin::Badge.count') do
      post admin_badges_url, params: { admin_badge: { title: @admin_badge.title, url: @admin_badge.url } }
    end
  ...
  test "should update admin_badge" do
    patch admin_badge_url(@admin_badge), params: { admin_badge: { title: @admin_badge.title, url: @admin_badge.url } }
